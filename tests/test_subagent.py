...
from lazycode.agents.parser import AgentDef, AgentParseError, parse_agent_file, parse_frontmatter
...
from lazycode.agents.fork import (
    FORK_BOILERPLATE_TAG,
    ForkError,
    build_forked_messages,
)
from lazycode.agents.trace import TraceManager, TraceNode
from lazycode.agents.task_manager import BackgroundTask, TaskManager
...
class TestAgentLoader:
    ...
    def test_project_overrides_builtin(self, tmp_path: Path):
        agents_dir = tmp_path / ".lazycode" / "agents"
...
class TestPermissionMode:
    def test_dont_ask_mode(self):
        from lazycode.permissions.modes import PermissionMode, mode_decide
...
class TestAgentToolParams:
    def test_required_fields(self):
        from lazycode.tools.agent_tool import AgentToolParams
