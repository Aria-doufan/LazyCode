...
from lazycode.skills.parser import (
    SkillDef,
    SkillParseError,
    parse_frontmatter,
    parse_skill_file,
...
from lazycode.skills.executor import (
...
class TestSkillLoader:
    ...
    def test_project_overrides_builtin(self, tmp_path: Path) -> None:
        skills_dir = tmp_path / ".lazycode" / "skills"
...
class TestDirectorySkill:
    def test_parse_tool_json(self, tmp_path: Path) -> None:
        from lazycode.skills.directory import parse_tool_json
...
class TestLoadSkillTool:
    ...
    async def test_load_existing_skill(self) -> None:
        from lazycode.tools.load_skill import LoadSkill, LoadSkillParams
...
class TestAgentSkillIntegration:
    def test_activate_and_clear(self) -> None:
        ...
        from lazycode.prompts import build_environment_context
