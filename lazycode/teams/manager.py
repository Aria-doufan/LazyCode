...
from lazycode.teams.mailbox import Mailbox, create_message
...
from lazycode.teams.shared_task import SharedTaskStore
from lazycode.teams.spawn_inprocess import InProcessTeammateHandle
    ...
    def _kill_pane(self, pane_id: str, backend_type: str) -> None:
        ...
        try:
            if backend_type == BackendType.TMUX.value:
                from lazycode.teams.spawn_tmux import kill_pane
                kill_pane(pane_id)
