...
SESSION_SUBDIR = ".lazycode/session/tool-results"
...
async def auto_compact(
    ...
    for attempt in range(max_retries):
        try:
            from lazycode.tools.base import StreamEnd, StreamEvent, TextDelta
