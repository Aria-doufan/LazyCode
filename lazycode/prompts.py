"""构建 LazyCode 的 system prompt 内容。"""
...
BASE_PERSONA = "You are LazyCode, an AI programming assistant running in the terminal."

IDENTITY_SECTION = PromptSection(
    name="Identity",
    priority=0,
    content=(
        "You are LazyCode, an AI programming assistant running in the terminal. "
...
def build_system_prompt(
    ...
    """构建system prompt。"""
    if coordinator_mode:
        from lazycode.teams.coordinator import get_coordinator_system_prompt
