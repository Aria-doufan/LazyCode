...
from lazycode.skills.parser import SkillDef, SkillParseError, parse_frontmatter, parse_skill_file

log = logging.getLogger(__name__)

PROJECT_SKILLS_DIR = ".lazycode/skills"
USER_SKILLS_DIR = "~/.lazycode/skills"
...
class SkillLoader:
    ...
    def _load_builtins(self) -> list[SkillDef]:
        """加载builtins。"""
        results: list[SkillDef] = []
        builtins_pkg = importlib.resources.files("lazycode.skills.builtins")
        ...
        for resource in builtins_pkg.iterdir():
            ...
            try:
                ...
                from lazycode.skills.parser import _validate_meta
