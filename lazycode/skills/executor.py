...
from lazycode.skills.parser import SkillDef, substitute_arguments
from lazycode.tools import ToolRegistry

if TYPE_CHECKING:
    from lazycode.agent import Agent, AgentEvent
...
class SkillExecutor:
    ...
    async def execute_fork(
        ...
        from lazycode.agent import Agent as AgentClass, StreamText, LoopComplete, ErrorEvent
