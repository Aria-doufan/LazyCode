...
PROJECT_AGENTS_DIR = ".lazycode/agents"
USER_AGENTS_DIR = "~/.lazycode/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        ...
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("lazycode.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from lazycode.agents.parser import parse_frontmatter, _validate_agent_meta
